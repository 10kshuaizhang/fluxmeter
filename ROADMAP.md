...
**Current version:** 3.3.0 (engine) · 1.5.0 (Python SDK) · 1.3.0 (JS SDK pack-ready)  
...
| **ClickHouse cold store (ADR-1)** | **Shipped 3.3.0** — `raw_events` + DLQ; aggregates via `benchmark_init.sql` only |
