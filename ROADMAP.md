...
**Current version:** 2.2.1 (engine) · 1.1.0 (Python SDK on PyPI)  
...
|------|----------|-------------|------------------|
| README / SHOW_HN version sync | P0 | Align marketing docs with 2.2.1 + dual-path story | README badge matches `build.gradle` |
...
**Target release:** 2.2.2 or 2.3.0 (MINOR if tiered pricing lands)
